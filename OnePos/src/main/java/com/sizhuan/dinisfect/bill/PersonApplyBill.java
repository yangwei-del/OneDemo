 ...
 * 人员申请单
 */
public class PersonApplyBill extends AbstractBillPlugIn implements BeforeF7SelectListener {
    @Override
    ...
    public void propertyChanged(PropertyChangedArgs e) {
        ...
        if(StringUtil.equals(propertiesName,"kded_datefield")){
            ...
            if (currentData.compareTo(selectData) > 0) {
                this.getView().showTipNotification("选择时间只能大于当前时间");
    ...
    public void itemClick(ItemClickEvent evt) {
        ...
        if(StringUtil.equals(operKey,"kded_baritemap")){
            ...
            billShowParameter.setFormId("kded_disinfect_record");
            billShowParameter.setAppId("kded_disinfect_system");
